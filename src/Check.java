...
public class Check extends Base {
	...
	protected void createTargets() {
		outputTarget = this.createRelationalTarget(SourceTargetType.Teradata,
				"O_" + org.tools.GetProperties.getKeyValue("System") + "_"
						+ org.tools.GetProperties.getKeyValue("TableNm").toUpperCase()+"_CK");
	}
...
//				"UPD_" + org.tools.GetProperties.getKeyValue("TableNm")).getRowSets().get(0);
		...
		RowSet filterRS = (RowSet) helper.filter(expRowSet2, "IIF(ISNULL(MD5ALL),'0',MD5ALL) != IIF(ISNULL(IN_MD5ALL),'0',IN_MD5ALL)",
				"FIT_" + org.tools.GetProperties.getKeyValue("TableNm")).getRowSets().get(0);
	...
	protected void createWorkflow() throws Exception {
		...
		workflow = new Workflow("WF_CHECK_" +org.tools.GetProperties.getKeyValue("System")+"_"+ org.tools.GetProperties.getKeyValue("TableNm").toUpperCase(),
				"WF_" + org.tools.GetProperties.getKeyValue("TableNm").toUpperCase()+"_CK", "This workflow for joiner");
	...
	protected void createSession() throws Exception {
		...
		session = new Session("S_"+org.tools.GetProperties.getKeyValue("System")+"_" + org.tools.GetProperties.getKeyValue("TableNm").toUpperCase()+"_CK",
