...
//	protected String TableNm = org.tools.GetProperties.getKeyValue("TableNm");
	...
	protected void createFolder() {
		folder = new Folder("WECHAT", "WECHAT",
	...
	protected Source createOracleViewSource(String dbName) {
		...
		fields.add(OWNER);
		Field SEGMENT_NAME=new Field("SEGMENT_NAME","SEGMENT_NAME","",NativeDataTypes.Oracle.VARCHAR2,"81","0",FieldKeyType.NOT_A_KEY,FieldType.SOURCE,false);
		fields.add(SEGMENT_NAME);
		Field PARTITION_NAME=new Field("PARTITION_NAME","PARTITION_NAME","",NativeDataTypes.Oracle.VARCHAR2,"30","0",FieldKeyType.NOT_A_KEY,FieldType.SOURCE,false);
		fields.add(PARTITION_NAME);
		Field SEGMENT_TYPE=new Field("SEGMENT_TYPE","SEGMENT_TYPE","",NativeDataTypes.Oracle.VARCHAR2,"18","0",FieldKeyType.NOT_A_KEY,FieldType.SOURCE,false);
		fields.add(SEGMENT_TYPE);
		Field SEGMENT_SUBTYPE=new Field("SEGMENT_SUBTYPE","SEGMENT_SUBTYPE","",NativeDataTypes.Oracle.VARCHAR2,"10","0",FieldKeyType.NOT_A_KEY,FieldType.SOURCE,false);
		fields.add(SEGMENT_SUBTYPE);
		Field TABLESPACE_NAME=new Field("TABLESPACE_NAME","TABLESPACE_NAME","",NativeDataTypes.Oracle.VARCHAR2,"30","0",FieldKeyType.NOT_A_KEY,FieldType.SOURCE,false);
		fields.add(TABLESPACE_NAME);
		Field HEADER_FILE=new Field("HEADER_FILE","HEADER_FILE","",NativeDataTypes.Oracle.VARCHAR2,"15","0",FieldKeyType.NOT_A_KEY,FieldType.SOURCE,false);
		fields.add(HEADER_FILE);
		Field HEADER_BLOCK=new Field("HEADER_BLOCK","HEADER_BLOCK","",NativeDataTypes.Oracle.VARCHAR2,"15","0",FieldKeyType.NOT_A_KEY,FieldType.SOURCE,false);
		fields.add(HEADER_BLOCK);
		Field BYTES=new Field("BYTES","BYTES","",NativeDataTypes.Oracle.VARCHAR2,"15","0",FieldKeyType.NOT_A_KEY,FieldType.SOURCE,false);
		fields.add(BYTES);
		Field BLOCKS=new Field("BLOCKS","BLOCKS","",NativeDataTypes.Oracle.VARCHAR2,"15","0",FieldKeyType.NOT_A_KEY,FieldType.SOURCE,false);
		fields.add(BLOCKS);
		Field EXTENTS=new Field("EXTENTS","EXTENTS","",NativeDataTypes.Oracle.VARCHAR2,"15","0",FieldKeyType.NOT_A_KEY,FieldType.SOURCE,false);
		fields.add(EXTENTS);
		Field INITIAL_EXTENT=new Field("INITIAL_EXTENT","INITIAL_EXTENT","",NativeDataTypes.Oracle.VARCHAR2,"15","0",FieldKeyType.NOT_A_KEY,FieldType.SOURCE,false);
		fields.add(INITIAL_EXTENT);
		Field NEXT_EXTENT=new Field("NEXT_EXTENT","NEXT_EXTENT","",NativeDataTypes.Oracle.VARCHAR2,"15","0",FieldKeyType.NOT_A_KEY,FieldType.SOURCE,false);
		fields.add(NEXT_EXTENT);
		Field MIN_EXTENTS=new Field("MIN_EXTENTS","MIN_EXTENTS","",NativeDataTypes.Oracle.VARCHAR2,"15","0",FieldKeyType.NOT_A_KEY,FieldType.SOURCE,false);
		fields.add(MIN_EXTENTS);
		Field MAX_EXTENTS=new Field("MAX_EXTENTS","MAX_EXTENTS","",NativeDataTypes.Oracle.VARCHAR2,"15","0",FieldKeyType.NOT_A_KEY,FieldType.SOURCE,false);
		fields.add(MAX_EXTENTS);
		Field MAX_SIZE=new Field("MAX_SIZE","MAX_SIZE","",NativeDataTypes.Oracle.VARCHAR2,"15","0",FieldKeyType.NOT_A_KEY,FieldType.SOURCE,false);
		fields.add(MAX_SIZE);
		Field RETENTION=new Field("RETENTION","RETENTION","",NativeDataTypes.Oracle.VARCHAR2,"7","0",FieldKeyType.NOT_A_KEY,FieldType.SOURCE,false);
		fields.add(RETENTION);
		Field MINRETENTION=new Field("MINRETENTION","MINRETENTION","",NativeDataTypes.Oracle.VARCHAR2,"15","0",FieldKeyType.NOT_A_KEY,FieldType.SOURCE,false);
		fields.add(MINRETENTION);
		Field PCT_INCREASE=new Field("PCT_INCREASE","PCT_INCREASE","",NativeDataTypes.Oracle.VARCHAR2,"15","0",FieldKeyType.NOT_A_KEY,FieldType.SOURCE,false);
		fields.add(PCT_INCREASE);
		Field FREELISTS=new Field("FREELISTS","FREELISTS","",NativeDataTypes.Oracle.VARCHAR2,"15","0",FieldKeyType.NOT_A_KEY,FieldType.SOURCE,false);
		fields.add(FREELISTS);
		Field FREELIST_GROUPS=new Field("FREELIST_GROUPS","FREELIST_GROUPS","",NativeDataTypes.Oracle.VARCHAR2,"15","0",FieldKeyType.NOT_A_KEY,FieldType.SOURCE,false);
		fields.add(FREELIST_GROUPS);
		Field RELATIVE_FNO=new Field("RELATIVE_FNO","RELATIVE_FNO","",NativeDataTypes.Oracle.VARCHAR2,"15","0",FieldKeyType.NOT_A_KEY,FieldType.SOURCE,false);
		fields.add(RELATIVE_FNO);
		Field BUFFER_POOL=new Field("BUFFER_POOL","BUFFER_POOL","",NativeDataTypes.Oracle.VARCHAR2,"7","0",FieldKeyType.NOT_A_KEY,FieldType.SOURCE,false);
		fields.add(BUFFER_POOL);
		Field FLASH_CACHE=new Field("FLASH_CACHE","FLASH_CACHE","",NativeDataTypes.Oracle.VARCHAR2,"7","0",FieldKeyType.NOT_A_KEY,FieldType.SOURCE,false);
		fields.add(FLASH_CACHE);
		Field CELL_FLASH_CACHE=new Field("CELL_FLASH_CACHE","CELL_FLASH_CACHE","",NativeDataTypes.Oracle.VARCHAR2,"7","0",FieldKeyType.NOT_A_KEY,FieldType.SOURCE,false);
...
//		fields.add(endDate);
	...
	protected Target createDbasegmentTarget(SourceTargetType DBType, String name) {
		...
		ConnectionInfo info = getRelationalConnInfo(SourceTargetType.Oracle,
				name);
		sasTgt = new Target("DBA_SEGMENTS", "DBA_SEGMENTS", "This is oracle table", "DBA_SEGMENTS",
				info);
		sasTgt.setFields(fields);
...
//        System.out.println("<ATTRIBUTE NAME=\"Parameter Filename\" VALUE=\"$PMRootDir/EDWParam/edw.param\"/>");
		org.tools.ConFileContent.writeLog(org.tools.ConFileContent.ReplaceColumnNm("M_"+org.tools.GetProperties.getKeyValue("TableNm").toUpperCase()+".xml"));
	}
...
//			      System.out.println(a.get(3).toString().trim().equals("PI")+ a.get(3).toString().trim());
			      if (a.get(3).toString().trim().equals("PI") || a.get(1).toString().trim().equals(org.tools.GetProperties.getKeyValue("IDColunmNM"))){
